...
class BanditEnv:
    ...
    def step(self, action: int) -> Tuple[float, int]:
        ...
        return reward, action #comment this while answering q4, uncomment this while answering q6,q7
        # return reward       #comment this while answering q6,q7, uncomment this while answering q4
